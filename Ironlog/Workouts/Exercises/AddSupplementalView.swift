...
struct AddSupplementalView: View {
    ...
    func createNewExercise() -> Void {
        ...
        let newExercise = SupplementalExercise(context: viewContext)
        ...
        workout.supplementalExercise = newExercise
...
struct AddSupplementalView_Previews: PreviewProvider {
